...
- Возраст зданий (до 300+ лет)

**Что можно анализировать:**
- Относительная стоимость районов
- Влияние характеристик на цену
- Сезонность внутри года
- Сравнение типов недвижимости

**Ограничения:**
- Нет данных для долгосрочных трендов
...
# Страница 1: Визуализация данных
    ...
    **ℹ️ Важная информация о данных:**
    ...
    - Год постройки показывает возраст зданий, а не период продаж
...
# Страница 3: Прогнозные модели
    ...
    Данные охватывают только 12 месяцев. Модели могут предсказывать только:
    1. Цену на основе характеристик объекта
    2. Сезонные паттерны внутри года
    3. Категорию цены объекта
    """)
    ...
    # Модель 2: Анализ сезонности
        ...
        if 'SALE_MONTH' not in filtered_df.columns:
            ...
            if most_expensive_month['Месяц'] in [5, 6, 7]:  # Весна/лето
                ...
                recommendations.append("❄️ **Высокие цены** наблюдаются в зимние месяцы")
