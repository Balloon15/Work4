...
page = st.sidebar.radio('Выберите страницу:', ['Визуализация исходных данных', ['Таблица с первыми строками данных', ' Базовые статистики', 'Распределения признаков', 'Корреляционная матрица', 'Примеры визуализаций', 'Фильтры'], 'Результаты анализа'])
